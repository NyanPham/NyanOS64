...
int main()
{
    ...
    params.y = 150;
    params.width = 300;
    params.height = 200 + WIN_TITLE_BAR_H;
    ...
    draw_rect(0, WIN_TITLE_BAR_H, params.width, params.height - WIN_TITLE_BAR_H, 0xFF333333);
        ...
        if (res == 1)
        {
            if (e.type == EVENT_KEY_PRESSED)
            {
                ...
                else if (e.key == 'c')
                {
                    ...
                    draw_rect(100, 50 + WIN_TITLE_BAR_H, 100, 100, box_color);
                }
            }
            else if (e.type == EVENT_WIN_RESIZE)
            {
                draw_rect(0, WIN_TITLE_BAR_H, 2000, 2000, 0xFF333333);
                draw_rect(100, 50 + WIN_TITLE_BAR_H, 100, 100, box_color);
            }
        }
    }
